...
abstract contract PrivateDAO is MerkleTreeWithHistory, ReentrancyGuard, typesPublicInput {
  ...
  */
    function deposit(
        ...
        bytes32 _pointP,
        bytes32 _pointQ,
        bytes32 _pointNullifier
    ) external payable nonReentrant {
        require(!commitments[_commitment], "The commitment has been submitted");
        require(msg.value > 0, "The value should be non negative");
